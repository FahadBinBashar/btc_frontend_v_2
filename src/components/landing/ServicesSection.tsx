...
const services = [
  ...
  },
  {
    id: "kyc-v2",
    icon: UserCheck,
    title: "KYC Journey V2",
    description: "Journey-based KYC with SMEGA opt-in at MSISDN step and backend orchestration.",
    features: ["SMEGA Yes/No at MSISDN", "OTP challenge flow", "Final KYC + SMEGA status"],
